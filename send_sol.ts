...
const recipient = new PublicKey("CqUHM9zQGSVL9iGp2mtipvBH1nuhkXzoSdhiZphTKJ6u");

console.log(`Attempting to sent 0.01 SOL to ${recipient.toBase58()} ... `);
...
(async()=>{
    ...
    console.log(`Transaction confirm ${signature}`);
})();
